!(function (t) {
  ...
  function O() {
    if (!R) {
      ...
      do {
        ...
        for (b(null), w.length = 0; C.length; ) C.pop()();
  ...
  function D(t, e, n, r, o, a, s, i, c, l, d, u) {
    ...
    for (m = p; m--; ) {
      const t = u(o, a, m),
        i = n(t);
      let c = s.get(i);
      c ? r && c.p(t, e) : ((c = l(i, t)), c.c()), y.set(i, (h[m] = c)), i in g && $.set(i, Math.abs(m - g[i]));
    }
    const b = new Set(),
      x = new Set();
    function k(t) {
      z(t, 1), t.m(i, d), s.set(t.key, t), (d = t.first), p--;
    }
    for (; f && p; ) {
      const e = h[p - 1],
        n = t[f - 1],
        r = e.key,
        o = n.key;
      e === n ? ((d = e.first), f--, p--) : y.has(o) ? (!s.has(r) || b.has(r) ? k(e) : x.has(o) ? f-- : $.get(r) > $.get(o) ? (x.add(r), k(e)) : (b.add(o), f--)) : (c(n, s), f--);
    }
    for (; f--; ) {
      const e = t[f];
      y.has(e.key) || c(e, s);
  ...
  function Y(t, e) {
    -1 === t.$$.dirty[0] && (w.push(t), L || ((L = !0), N.then(O)), t.$$.dirty.fill(0)), (t.$$.dirty[(e / 31) | 0] |= 1 << e % 31);
  }
    ...
    if (
      ((f.ctx = a
        ? a(e, o.props || {}, (t, n, ...r) => {
            ...
            return f.ctx && i(f.ctx[t], (f.ctx[t] = o)) && (!f.skip_bound && f.bound[t] && f.bound[t](o), p && Y(e, t)), n;
          })
        : []),
      f.update(),
      (p = !0),
      ...
      if (o.hydrate) {
        const t = ((m = o.target), Array.from(m.childNodes));
  ...
  var Q = (function t(e) {
      function n(t, e, r) {
        ...
        for (o in t) a[r ? o.toLowerCase() : o] = t[o];
        for (o in e) {
      ...
      function r(t, r, o, a) {
        ...
        (i.transformRequest || []).map(function (t) {
          ...
          l && "object" == typeof l && "function" != typeof l.append && ((l = JSON.stringify(l)), (c["content-type"] = "application/json"));
        var d = "undefined" != typeof document && document.cookie.match(RegExp("(^|; )" + i.xsrfCookieName + "=([^;]*)"));
        if ((d && (c[i.xsrfHeaderName] = d[2]), i.auth && (c.authorization = i.auth), i.baseURL && (t = t.replace(/^(?!.*\/\/)\/?(.*)$/, i.baseURL + "/$1")), i.params)) {
          var u = ~t.indexOf("?") ? "&" : "?";
          t += u + (i.paramsSerializer ? i.paramsSerializer(i.params) : new URLSearchParams(i.params));
        }
        return (i.fetch || fetch)(t, { method: o || i.method, body: l, headers: n(i.headers, c, !0), credentials: i.withCredentials ? "include" : "same-origin" }).then(function (t) {
          for (var e in t) "function" != typeof t[e] && (s[e] = t[e]);
          var n = i.validateStatus ? i.validateStatus(t.status) : t.ok;
          return "stream" == i.responseType
            ? ((s.data = t.body), s)
  ...
  function W(t) {
    const e = window.CUSDIS_LOCALE || V,
      n = e[t] || V[t];
    return e[t] || console.warn("[cusdis]", "translation of language key", `'${t}'`, "is missing."), n;
  }
  function X(e) {
    let n,
      o,
      ...
      M,
      T,
      q = (e[3] ? W("sending") : W("post_comment")) + "";
    return {
      c() {
        (n = l("div")),
          (o = l("div")),
          ...
          m(f, "for", "nickname"),
          m(b, "name", "nickname"),
          m(b, "class", "w-full p-2 border border-gray-200 bg-transparent dark:text-gray-100 dark:outline-none"),
          m(b, "type", "text"),
          m(b, "title", W("nickname")),
          m(a, "class", "px-1"),
          ...
          m(S, "class", "px-1"),
          m(A, "class", "text-sm bg-gray-200 p-2 px-4 font-bold dark:bg-transparent dark:border dark:border-gray-100"),
          y(A, "cusdis-disabled", e[3]),
          m(R, "class", "px-1"),
      ...
      m(t, r) {
        i(t, n, r),
          ...
          s(R, A),
          s(A, O),
          M || ((T = [p(b, "input", e[7]), p(w, "input", e[8]), p(L, "input", e[9]), p(A, "click", e[4])]), (M = !0));
      },
      p(t, [e]) {
        2 & e && b.value !== t[1] && h(b, t[1]), 4 & e && w.value !== t[2] && h(w, t[2]), 1 & e && h(L, t[0]), 8 & e && q !== (q = (t[3] ? W("sending") : W("post_comment")) + "") && g(O, q), 8 & e && y(A, "cusdis-disabled", t[3]);
      },
      i: t,
      o: t,
      d(t) {
        ...
        async function () {
          if (o)
            if (a)
              try {
                n(3, (i = !0));
                await l.post("/api/open/comments", { appId: u, pageId: f, content: o, nickname: a, email: s, parentId: r, pageUrl: p, pageTitle: m });
                await g(), n(0, (o = "")), n(1, (a = "")), n(2, (s = "")), c && c(), d(W("comment_has_been_sent"));
              } finally {
                n(3, (i = !1));
              }
            else alert(W("nickname_is_required"));
          else alert(W("content_is_required"));
        },
        r,
        c,
        function () {
  ...
  function rt(t) {
    ...
    return {
      ...
      i(t) {
        if (!n) {
          for (let t = 0; t < a.length; t += 1) z(r[t]);
          n = !0;
        }
      },
      o(t) {
        for (let e = 0; e < r.length; e += 1) P(r[e]);
        n = !1;
      },
      d(t) {
  ...
  function ot(t, e) {
    let n, r, o;
    return (
      (r = new ct({ props: { isChild: !0, comment: e[6] } })),
      {
        key: t,
        first: null,
        c() {
  ...
  function at(t) {
    ...
    return (
      (n = new tt({ props: { parentId: t[1].id, onSuccess: t[5] } })),
      {
        ...
        p(t, e) {
          const r = {};
          2 & e && (r.parentId = t[1].id), 1 & e && (r.onSuccess = t[5]), n.$set(r);
        },
        i(t) {
  ...
  function st(t) {
    let e,
      ...
      E = t[1].parsedCreatedAt + "",
      R = t[1].parsedContent + "",
      A = t[1].moderatorId && nt(),
      O = t[1].replies.data.length > 0 && rt(t),
      M = t[0] && at(t);
    return {
      c() {
        (e = l("div")),
      ...
      m(c, l) {
        i(c, e, l),
          ...
          M && M.m(e, null),
          (S = !0),
          I || ((N = p(w, "click", t[4])), (I = !0));
      },
      p(t, [r]) {
        (!S || 2 & r) && L !== (L = (t[1].moderator && t[1].moderator.displayName ? t[1].moderator.displayName : t[1].by_nickname) + "") && g(o, L),
          t[1].moderatorId ? (A ? A.p(t, r) : ((A = nt()), A.c(), A.m(n, null))) : A && (A.d(1), (A = null)),
          (!S || 2 & r) && E !== (E = t[1].parsedCreatedAt + "") && g($, E),
          (!S || 2 & r) && R !== (R = t[1].parsedContent + "") && (x.innerHTML = R),
          t[1].replies.data.length > 0
            ? O
              ? (O.p(t, r), 2 & r && z(O, 1))
              : ((O = rt(t)), O.c(), z(O, 1), O.m(e, v))
            : O &&
              (j(),
              P(O, 1, 1, () => {
                O = null;
  ...
  function ut(t) {
    ...
    return (
      ...
      (g = C[p] = w[p](t)),
      {
        ...
        m(t, c) {
          i(t, e, c), _ && _.m(e, null), s(e, n), J(r, e, null), s(e, o), s(e, a), s(e, d), s(e, f), C[p].m(f, null), s(e, h), s(e, $), s(e, b), s(e, x), s(x, k), (v = !0);
        },
        p(t, r) {
          t[4] ? (_ ? _.p(t, r) : ((_ = ft(t)), _.c(), _.m(e, n))) : _ && (_.d(1), (_ = null));
          let o = p;
          (p = S(t)),
            p === o
              ? C[p].p(t, r)
              : (j(),
                ...
                U(),
                (g = C[p]),
                g ? g.p(t, r) : ((g = C[p] = w[p](t)), g.c()),
                z(g, 1),
                g.m(f, null)),
            2 & r && y(e, "dark", "dark" === t[1]);
        },
        i(t) {
  ...
  function ft(t) {
    ...
    return {
      c() {
        (e = l("div")), (n = d(t[4])), m(e, "class", "p-2 mb-4 bg-blue-500 text-white");
      },
      m(t, r) {
        i(t, e, r), s(e, n);
      },
  ...
  function pt(t) {
    ...
    return {
      ...
      m(t, a) {
        ...
        i(t, e, a), d && d.m(t, a), i(t, n, a), (r = !0);
      },
      p(t, r) {
        1 & r && ((s = t[0].data), j(), (o = D(o, r, l, 1, t, s, a, e.parentNode, F, gt, e, dt)), U()), t[0].pageCount > 1 ? (d ? d.p(t, r) : ((d = ht(t)), d.c(), d.m(n.parentNode, n))) : d && (d.d(1), (d = null));
      },
      i(t) {
        if (!r) {
          for (let t = 0; t < s.length; t += 1) z(o[t]);
          r = !0;
        }
      },
      o(t) {
  ...
  function gt(t, e) {
    let n, r, o;
    return (
      (r = new ct({ props: { comment: e[15], firstFloor: !0 } })),
      {
        key: t,
        first: null,
        c() {
  ...
  function ht(t) {
    let e,
      ...
      r = [];
    for (let o = 0; o < n.length; o += 1) r[o] = yt(lt(t, n, o));
    return {
      c() {
        e = l("div");
        for (let t = 0; t < r.length; t += 1) r[t].c();
      ...
      m(t, n) {
        i(t, e, n);
        for (let o = 0; o < r.length; o += 1) r[o].m(e, null);
      },
      p(t, o) {
        if (69 & o) {
          let a;
          for (n = Array(t[0].pageCount), a = 0; a < n.length; a += 1) {
            const s = lt(t, n, a);
            r[a] ? r[a].p(s, o) : ((r[a] = yt(s)), r[a].c(), r[a].m(e, null));
          }
  ...
  function yt(t) {
    ...
    return {
      c() {
        (e = l("button")), (n = d(a)), m(e, "class", "px-2 py-1 text-sm mr-2 dark:text-gray-200"), y(e, "underline", t[2] === t[14] + 1);
      },
      m(t, a) {
        i(t, e, a), s(e, n), r || ((o = p(e, "click", u)), (r = !0));
      },
      p(n, r) {
        (t = n), 4 & r && y(e, "underline", t[2] === t[14] + 1);
      },
      d(t) {
        t && c(e), (r = !1), o();
      },
    ...
    return {
      ...
      p(t, [n]) {
        t[5]
          ...
          : r
          ? (r.p(t, n), 32 & n && z(r, 1))
          : ((r = ut(t)), r.c(), z(r, 1), r.m(e.parentNode, e));
      },
      i(t) {
        n || (z(r), (n = !0));
      },
  ...
  function bt(t, e, n) {
    ...
    async function u(t = 1) {
      n(3, (i = !0));
      try {
        const e = await d.get("/api/open/comments", { headers: { "x-timezone-offset": -new Date().getTimezoneOffset() }, params: { page: t, appId: o.appId, pageId: o.pageId } });
        n(0, (a = e.data.data));
      } catch (e) {
        n(5, (r = e));
      } finally {
    ...
    return (
      ...
      (t.$$.update = () => {
        2 & t.$$.dirty && document.documentElement.style.setProperty("color-scheme", l);
      }),
      [a, l, s, i, c, r, f, o, (t, e) => f(t + 1)]
    );
  }
  window.CUSDIS = {};
  ...
  new (class extends K {
    constructor(t) {
      super(), G(this, t, bt, $t, a, { attrs: 7, commentsResult: 0 });
    }
